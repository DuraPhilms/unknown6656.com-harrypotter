...
?>
            ...
            <div id="video-section" class="default">
                ...
                <video id="player" width="700" height="400" controls playsinline allowfullscreen autoPictureInPicture="true" preload="metadata" poster="images/title.png">
                    <source id="player-source" type="video/mp4" src=""/>
